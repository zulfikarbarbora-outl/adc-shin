...
Opus 48 kbps previews for the **karoryfer.shinyguitar** sample library.
...
```
https://raw.githubusercontent.com/zulfikarbarbora-outl/shinyguitar-opus-48/master/<filename>.opus
```
